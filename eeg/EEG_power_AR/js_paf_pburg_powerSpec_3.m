function [power,ff, i1, i2] = js_paf_pburg_powerSpec_3(data, p, t, epochl, fs, tit, toPlot, seg, savePath)
%
%   data: EEG data
%   p: order of AR model
...
if (toPlot==1)
    ...
    linkaxes([a1,a2], 'x');
    savefig(h, [savePath, tit, '_spectrogram.fig']);
    print(h, '-dtiff', '-r200', [savePath, tit, '_spectrogram.tif']);
